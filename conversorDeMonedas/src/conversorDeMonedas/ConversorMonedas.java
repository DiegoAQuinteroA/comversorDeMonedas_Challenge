...
public class ConversorMonedas {
	...
	/**
	 * ejecuta el modulo de convercion adecuado segun el valor elejido de la lista "ListacomvercionADivisas"
	 * @param comvercionADivisas valor elegido de la lista por el usuario
	 * @param valorDouble valor a convertir ingresado por el usuario.
	 */
